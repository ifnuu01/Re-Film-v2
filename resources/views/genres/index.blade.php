                    ...
                    <tr class="hover:bg-[#161A20]">
                        ...
                        <td class="py-2 px-2">
                            <form action="{{route('genres.destroy', $genre->id)}}" method="POST" class="flex gap-x-2">
                                @method('DELETE')
                                @csrf
                                <a href="{{route('genre.show', $genre->id)}}" class="flex items-center w-fit bg-[#2EBCF9] px-6  py-2 rounded-full"><svg class="w-[16px] fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg></a>
